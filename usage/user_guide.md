...
### C/C++ Type:
This filed is automatically updated when the function is picked in the “Top Level Tab” and is the type of the argument. The two type ***hls::stream*** and  ***vsi::device***  have special handling .
### Execution Trigger:
...
### Variable Length:
***Software Context*** : This is used ***only*** when the direction in ***Input and Type in a Array***, see table in “Type” for more details.
***Hardware Context***: This is used ***only*** when the direction in ***Input and Access Type is Sequential*** , see table in “Type” for more details.
### Access Type:
