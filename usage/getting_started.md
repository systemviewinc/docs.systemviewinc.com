...
![alt text](/img/img_getting_started/choose_example_type.png)
...
![alt text](/img/img_getting_started/import_existing_platform_4.png)
...
![alt text](/img/img_getting_started/generate_System_01.png)
...
![alt text](/img/img_getting_started/build_HLS_01.png)
...
![alt text](/img/img_getting_started/build_software_01.png)
...
![alt text](/img/img_getting_started/build_hardware_01.png)
...
- Build the driver with make:make CROSS_COMPILE=arm-linux-gnueabihf- ARCH=arm KERNEL_SOURCES=/< home\_dir\>/build/driver_vsi/linux-xlnx
### Copying Files:
