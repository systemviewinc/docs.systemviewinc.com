...
- The example will send 256 bytes of data through each block. A statement on console is printed each 100,000 iteration.

## Exercise

- Try modifying the test string.
- Modify the iteration cycle when a statement is printed to 1,000,000.
- Change the design to have another python block.
