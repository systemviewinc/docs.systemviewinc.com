...
#### Manual Steps
1. Download the installation file from [Here](/releases.md) (Make sure to choose the major version that corresponds to the Vivado version that is installed on the host)<sup>4</sup>
...
5. Windows HLS build fail, There is a walk around solution.
	- C:\Xilinx\Vivado\2017.4\win64\tools\clang\include\c++\4.5.2\exception_ptr.h  add the below code before extern "C++":
		\#ifdef \__clang__
    class type_info;
		\#endif
